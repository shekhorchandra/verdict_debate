...
class DebateDetailView extends GetView<DebateDetailController> {
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(
            "Following",
            style: AppText.h5().copyWith(color: Colors.white54),
          ),
          const Spacer(),
          const Icon(
  ...
  Widget _buildProfileHeader() {
    return Row(
      children: [
        const CircleAvatar(
          radius: 25,
          backgroundImage: NetworkImage('https://i.pravatar.cc/150?u=zara'),
        ),
      ...
      () => Column(
        children: [
          Row(
            ...
            children: [
              Text(
                "${controller.disagreePercent}%",
                style: AppText.label.bold.copyWith(
                  color: const Color(0xFFFF006E),
                ),
              ),
              Text(
                "${controller.agreePercent}%",
                style: AppText.label.bold.copyWith(
          ...
          Row(
            children: [
              Expanded(
                flex: controller.disagreePercent.value,
                child: Container(
                  height: 8,
                  decoration: const BoxDecoration(
              ...
              Expanded(
                flex: controller.agreePercent.value,
                child: Container(
                  height: 8,
                  decoration: const BoxDecoration(
  ...
  Widget _buildVotingInsights() {
    return InkWell(
      onTap: () {
        Get.toNamed(AppRoutes.VOTING_INSIGHTS);
      },
      borderRadius: BorderRadius.circular(12),
      child: Container(
          ...
          const Expanded(
            child: TextField(
              decoration: InputDecoration(
                hintText: "What's your thought about this discussion?",
