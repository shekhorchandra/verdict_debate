...
class LiveDebateChallengeDialog extends StatelessWidget {
  const LiveDebateChallengeDialog({Key? key}) : super(key: key);

  // @override
  // Widget build(BuildContext context) {
  //   // Access the controller already initialized by the page
  //   final LiveDebateController controller = Get.find<LiveDebateController>();
  //
  //   return Center(
  //     child: Material(
